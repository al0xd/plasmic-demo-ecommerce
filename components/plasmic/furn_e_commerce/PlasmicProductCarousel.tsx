...
import * as sty from "./PlasmicProductCarousel.module.css"; // plasmic-import: X788gSiuU8KF8X/css

import DotCircleOIcon from "./icons/PlasmicIcon__DotCircleO"; // plasmic-import: k5OIdLuPxhmI-7/icon
import CircleOIcon from "./icons/PlasmicIcon__CircleO"; // plasmic-import: C4t3-cjTiGw7k0/icon
...
function PlasmicProductCarousel__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__hgUvm)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__ypi7A, {
            [sty.box__slider_second__ypi7Avuyv7]: hasVariant(
              variants,
              "slider",
              "second"
            )
        ...
        >
          ...
          <div
            className={classNames(
              ...
              sty.box__gBAs,
              {
                [sty.box__slider_first__gBAsFvGu]: hasVariant(
                  variants,
                  "slider",
                  "first"
                ),
                [sty.box__slider_second__gBAsvuyv7]: hasVariant(
                  variants,
                  "slider",
                  "second"
                ),
                [sty.box__slider_third__gBAsmyK8K]: hasVariant(
                  variants,
                  "slider",
                  "third"
                )
          ...
          <div className={classNames(defaultcss.all, sty.box___3Hzw5)}>
            <div className={classNames(defaultcss.all, sty.box__t7ZmV)} />
            ...
            <div
              className={classNames(
                ...
                sty.box__qpy31,
                {
                  [sty.box__slider_second__qpy31Vuyv7]: hasVariant(
                    variants,
                    "slider",
                    "second"
                  ),
                  [sty.box__slider_third__qpy31MyK8K]: hasVariant(
                    variants,
                    "slider",
                    "third"
                  )
            ...
            <div
              className={classNames(
                ...
                sty.box__bBmVx,
                {
                  [sty.box__slider_first__bBmVxFvGu]: hasVariant(
                    variants,
                    "slider",
                    "first"
                  ),
                  [sty.box__slider_second__bBmVxvuyv7]: hasVariant(
                    variants,
                    "slider",
                    "second"
                  ),
                  [sty.box__slider_third__bBmVxmyK8K]: hasVariant(
                    variants,
                    "slider",
                    "third"
                  )
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__bFeSu)}
          >
            <LinkButton
              className={classNames("__wab_instance", sty.linkButton__fi32A)}
              text={"⊕ Add to cart"}
              type={"solidOrange" as const}
            />

            <LinkButton
              className={classNames("__wab_instance", sty.linkButton__cLTdO)}
              text={"More Info"}
        ...
        <div className={classNames(defaultcss.all, sty.box__dL2Cy)}>
          <img
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__xYq4R)}
      >
        <p.PlasmicIcon
          PlasmicIconType={
            hasVariant(variants, "slider", "third")
          ...
          className={classNames(defaultcss.all, sty.svg__uK9Aa, {
            [sty.svg__slider_second__uK9Aavuyv7]: hasVariant(
              variants,
              "slider",
              "second"
            ),
            [sty.svg__slider_third__uK9AamyK8K]: hasVariant(
              variants,
              "slider",
              "third"
            )
        ...
        <p.PlasmicIcon
          ...
          className={classNames(defaultcss.all, sty.svg__fuMIr, {
            [sty.svg__slider_first__fuMIrFvGu]: hasVariant(
              variants,
              "slider",
              "first"
            ),
            [sty.svg__slider_second__fuMIrvuyv7]: hasVariant(
              variants,
              "slider",
              "second"
            ),
            [sty.svg__slider_third__fuMIrmyK8K]: hasVariant(
              variants,
              "slider",
              "third"
            )
        ...
        <p.PlasmicIcon
          ...
          className={classNames(defaultcss.all, sty.svg__cq7Ek, {
            [sty.svg__slider_third__cq7EkmyK8K]: hasVariant(
              variants,
              "slider",
              "third"
            )
