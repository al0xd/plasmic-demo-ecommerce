...
import * as sty from "./PlasmicBlogPost.module.css"; // plasmic-import: qEjY_mf51k0AtM/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__boKvg, {
            [sty.box__long__boKvGeW4EU]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___3Tl2E, {
          [sty.box__long___3Tl2EeW4EU]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
